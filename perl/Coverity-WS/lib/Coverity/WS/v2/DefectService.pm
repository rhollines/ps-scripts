...
package Coverity::WS::v2::DefectService;
...
Coverity::WS::v2::DefectService - Perl interface for the Coverity Defect Service

=head1 DESCRIPTION

Coverity::WS::v2::DefectService provides a Perl native interface for the Coverity Integrity Manager Defect Service,
...
Some methods may require complex data types to be created. These DefectService types must be explicitly instantiated:
  ...
  my $severity = new Coverity::WS::v2::DefectService::severityDataObj;
  $severity->name = "Major";

  # Create a new defect change data object
  my $change = new Coverity::WS::v2::DefectService::defectStatusChangeDataObj;
