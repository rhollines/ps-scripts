...
package Coverity::WS::v2::AdministrationService;
...
Coverity::WS::v2::AdministrationService - Perl interface for the Coverity User Service

=head1 DESCRIPTION

Coverity::WS::v2::AdministrationService provides a Perl native interface for the Coverity Integrity Manager User Service,
...
The first step is to instantiate the AdministrationService, pointing it at the Coverity Integrity Manager:
  ...
  my $defectService = new Coverity::WS::v2::AdministrationService(
    remote => "localhost",
    port => 8080,
    username => "admin",
    password => "coverity"
...
Some methods may require complex data types to be created. These AdministrationService types must be explicitly instantiated:
  ...
  my $user = new Coverity::WS::v2::AdministrationService::userSpecDataObj;
